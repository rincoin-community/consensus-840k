...
|---|---|---|---|
| **C** | Rincoin Community Core 1.2.0, development build `v1.2.0-dev.2` | see [`build-manifest.json`](build-manifest.json) | the release build made by GitHub Actions, `rincoind` SHA-256 `c20215cdd30b09496a4fa48b6744d40ed3a045048cc11923d4ea0a301068c16c` |
